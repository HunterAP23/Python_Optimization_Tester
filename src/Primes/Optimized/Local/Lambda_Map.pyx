...
# @cython.cfunc
# @cython.locals(value_max=cython.int, num_loops=cython.int, i=cython.int, n=cython.int, average_time=cython.double)
...
# @cython.cfunc
# @cython.locals(value_max=cython.int, num_loops=cython.int, i=cython.int, n=cython.int, boundary=cython.int, average_time=cython.double)
# @ft.lru_cache(maxsize=None)
