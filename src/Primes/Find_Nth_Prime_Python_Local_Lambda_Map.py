...
def main_def(my_max, num_loops, rlock):
    ...
    time_output = open("files_runs/normal_local_lambda_map/default_time.txt", "w")
    ...
    for i in range(num_loops):
        ...
        for n in range(3, my_max, 2):
            ret = map(lambda y: n % y, primes_list)
    ...
    with open("files_runs/normal_local_lambda_map/default_divisions.txt", "w") as div_output:
        for div in div_list:
            div_output.write(div)

    with open("files_runs/normal_local_lambda_map/default_primes.txt", "w") as primes_output:
...
def main_half(my_max, num_loops, rlock):
    ...
    time_output = open("files_runs/normal_local_lambda_map/half_time.txt", "w")
    ...
    for i in range(num_loops):
        ...
        for n in range(3, my_max, 2):
            ...
            ret = map(lambda y: n % y if y <= boundary, primes_list)
    ...
    with open("files_runs/normal_local_lambda_map/half_divisions.txt", "w") as div_output:
        for div in div_list:
            div_output.write(div)

    with open("files_runs/normal_local_lambda_map/half_primes.txt", "w") as primes_output:
        for prime in primes_list:
            primes_output.write("{0}\n".format(prime))
...
def main_sqrt(my_max, num_loops, rlock):
    ...
    time_output = open("files_runs/normal_local_lambda_map/sqrt_time.txt", "w")
    ...
    with open("files_runs/normal_local_lambda_map/sqrt_divisions.txt", "w") as div_output:
        for div in div_list:
            div_output.write(div)

    with open("files_runs/normal_local_lambda_map/sqrt_primes.txt", "w") as primes_output:
        for prime in primes_list:
            primes_output.write("{0}\n".format(prime))
