...
def main_def(my_max, num_loops, rlock):
    ...
    txt_output.write("The average time it took to calculate {0} compiled default LRU passes was {1}.".format(num_loops, average_time))
    txt_output.close()
...
def main_half(my_max, num_loops, rlock):
    ...
    average_time = ft.reduce(lambda a, b: a + b, time_list) / len(time_list)
    txt_output.write("The average time it took to calculate {0} compiled half LRU passes was {1}.".format(num_loops, average_time))
    txt_output.close()
...
def main_sqrt(my_max, num_loops, rlock):
    ...
    average_time = ft.reduce(lambda a, b: a + b, time_list) / len(time_list)
    txt_output.write("The average time it took to calculate {0} compiled sqrt LRU passes was {1}.".format(num_loops, average_time))
    txt_output.close()
